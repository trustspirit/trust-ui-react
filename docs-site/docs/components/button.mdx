...
<ComponentPreview code={`<Button>Raised (default)</Button>
<Button elevation="flat">Flat</Button>`}>
...
<PropsTable props={[
  ...
  { name: 'elevation', type: "'flat' | 'raised'", default: "'raised' (primary/danger), 'flat' (others)", description: 'Visual elevation. Raised adds gradient + inset + hover lift.' },
