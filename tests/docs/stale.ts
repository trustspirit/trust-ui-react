...
export const STALE: string[] = [
  ...
  'docs-site/docs/design-tokens/colors.mdx',
  'docs-site/docs/design-tokens/elevation.mdx',
  'docs-site/docs/design-tokens/motion.mdx',
  'docs-site/docs/design-tokens/spacing.mdx',
  'docs-site/docs/design-tokens/typography.mdx',
